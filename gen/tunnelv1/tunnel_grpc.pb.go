...
type TunnelServiceClient interface {
	OpenTunnel(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[HttpResponse, HttpRequest], error)
}
...
func (c *tunnelServiceClient) OpenTunnel(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[HttpResponse, HttpRequest], error) {
...
type TunnelService_OpenTunnelClient = grpc.BidiStreamingClient[HttpResponse, HttpRequest]

// TunnelServiceServer is the server API for TunnelService service.
// All implementations must embed UnimplementedTunnelServiceServer
// for forward compatibility.
type TunnelServiceServer interface {
	OpenTunnel(grpc.BidiStreamingServer[HttpResponse, HttpRequest]) error
...
func (UnimplementedTunnelServiceServer) OpenTunnel(grpc.BidiStreamingServer[HttpResponse, HttpRequest]) error {
...
func _TunnelService_OpenTunnel_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TunnelServiceServer).OpenTunnel(&grpc.GenericServerStream[HttpResponse, HttpRequest]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type TunnelService_OpenTunnelServer = grpc.BidiStreamingServer[HttpResponse, HttpRequest]
...
var TunnelService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "tunnelv1/tunnel.proto",
}
